                 ...
                 case 2:{
                     ...
                     Scanner scnr21 = new Scanner(System.in);
                         ...
                         if(trans8 == 1){
                             ...
                             try {
                                FileWriter writer = new FileWriter("exports.txt");
        
                                for (exports expo : exportsarray) {
                                    writer.write(expo.getbatchNumber() + "," + expo.gettimeOfarrive() + "," + expo.getshipingCost() + "\n");
                                }
                            ...
                            try{
                                File exFile = new File("exports.txt");
                                Scanner scnrro = new Scanner(exFile);
                                while (scnrro.hasNextLine()) {
                                    String line = scnrro.nextLine();
                                    String[] parts = line.split(",");
                                    int batchNumber = Integer.parseInt(parts[0]);
                                    int timeOfLeaving = Integer.parseInt(parts[1]);
                                    double shippingCost = Double.parseDouble(parts[2]);
        
                                    System.out.println("Batch number: " + batchNumber);
                                    System.out.println("Batch time of leaving: " + timeOfLeaving);
                                    System.out.println("Batch shipping cost: " + shippingCost);
                                }
                             ...
                             for(exports expo:exportsarray){
                                 ...
                                 System.out.println("batch cost: " + expo.getshipingCost());
